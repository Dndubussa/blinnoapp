    ...
    <div className="min-h-screen bg-background dark:bg-slate-950">
      ...
      <main className="pt-20">
        <div className="container mx-auto px-4 py-8 lg:px-8">
          ...
          {(product.attributes?.previewFile || product.attributes?.audioFile) && product.category === "Music" && (
            <div className="mt-8">
              <AudioPreview
          ...
          {(product.attributes?.previewVideo || product.attributes?.videoFile) && product.category === "Music" && (
            <div className="mt-8">
              <VideoPreview
