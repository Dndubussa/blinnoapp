  ...
  const handleSecureDownload = async (product: any) => {
    ...
    try {
      ...
      setDownloadProgress((prev) => ({
        ...prev,
        [product.id]: { productId: product.id, progress: 0, fileName },
      }));
                            ...
                            >
                              {downloadingProduct === product.id ? (
                                <>
                                  ...
                                  {downloadProgress[product.id]?.progress || 0}%
                                </>
                              ...
                              <div className="mt-2">
                                <div className="relative w-full bg-secondary rounded-full h-2 overflow-hidden">
                                  <div 
                                    ...
                                    style={{ width: `${downloadProgress[product.id]?.progress || 0}%` }}
                                  />
                                </div>
                                <p className="text-xs text-muted-foreground mt-1">
                                  {downloadProgress[product.id]?.fileName}
                                </p>
                              </div>
                            )}
                          </div>
