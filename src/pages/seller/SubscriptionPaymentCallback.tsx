      ...
      try {
        ...
        if (paymentStatus === "successful" || paymentStatus === "completed") {
          ...
          toast({
            ...
            description: "Your subscription upgrade has been confirmed.",
          });

          // Redirect to subscription settings after a short delay
          setTimeout(() => {
            navigate("/seller/settings?tab=subscription", { replace: true });
          }, 2000);
        ...
        <CardContent className="p-8 text-center">
          ...
          {status === "success" && (
            <>
              ...
              <p className="text-muted-foreground mb-6">
                Your subscription upgrade has been confirmed. Redirecting to your subscription settings...
              </p>
              {reference && (
              ...
              <Button onClick={() => navigate("/seller/settings?tab=subscription", { replace: true })}>
                View Subscription
          ...
          {status === "failed" && (
            <>
              ...
              <div className="flex gap-3 justify-center">
                <Button variant="outline" onClick={() => navigate("/seller/settings?tab=subscription", { replace: true })}>
                  Back to Settings
                </Button>
          ...
          {status === "cancelled" && (
            <>
              ...
              <p className="text-muted-foreground mb-6">
                You cancelled the payment. You can upgrade your subscription when you're ready.
              </p>
              <Button onClick={() => navigate("/seller/settings?tab=subscription", { replace: true })}>
                Back to Settings
                <ArrowRight className="ml-2 h-4 w-4" />
