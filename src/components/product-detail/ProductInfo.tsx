          ...
          <div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              {product.category === "Music" && (
                <>
                  {attributes.musicTitle && (
                    <div>
                      <span className="text-sm font-medium text-muted-foreground">Song/Album Title</span>
                      <p className="mt-1 text-sm font-semibold">{attributes.musicTitle}</p>
                    </div>
                  )}
                  {attributes.artist && (
                    <div>
